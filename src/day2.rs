...
mod tests {
    ...
    #[test]
    fn task1_test_data() {
        assert_eq!(150, task1_run("data/day2_task1_test.txt"))
    }

    #[test]
    fn task1() {
        assert_eq!(2322630, task1_run("data/day2_task1.txt"))
    }

    #[test]
    fn task2_test_data() {
        assert_eq!(900, task2_run("data/day2_task1_test.txt"))
    }

    #[test]
    fn task2() {
        assert_eq!(2105273490, task2_run("data/day2_task1.txt"))
    }
}
